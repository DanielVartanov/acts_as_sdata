...
files = %w[ active_record_mixin atom_content_mixin atom_entry_mixin conditions_builder controller_mixin diagnosis namespace_definitions payload predicate route_mapper router_mixin virtual_base paylod_map ]
