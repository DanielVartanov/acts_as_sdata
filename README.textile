...
Let's consider we want to expose the list of US presidents in SData way (this is exactly what is done in "presidents":http://github.com/DanielVartanov/acts_as_sdata-examples/tree/master/presidents/ application in "examples":http://github.com/DanielVartanov/acts_as_sdata-examples repository).
